...
public class InviteScreen implements Screen, InputProcessor{
	...
	public InviteScreen(uParty u,Group groupR){
		this.u=u;
		this.groupR=groupR;
	}
	...
	public void show() {
		...
		create = new TextButton("Invite",u.standardButtonStyle);
		...
		group = new TextField(g,u.textFieldStyle);
			...
			group.setMessageText("Email to Invite");
	...
	public void render(float delta) {
		...
		layout.setText(u.largeFnt, "Invite");
		u.largeFnt.draw(pic, "Invite", u.w/2-layout.width/2, .7f*u.h-layout.height/2);
	...
	public boolean touchUp(int screenX, int screenY, int pointer, int button) {
		...
		if(Intersector.overlaps(touch, backB)){u.nextScreen = new GroupSettingsScreen(u,groupR);}
