...
public class HomeScreen implements Screen, InputProcessor{
	...
	public void show() {
		...
		u.redButtonStyle = new TextButtonStyle();
			u.redButtonStyle.up=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/FilledRed.png",Texture.class)));
			u.redButtonStyle.down=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/FilledRedChecked.png",Texture.class)));
			u.redButtonStyle.checked=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/FilledRedChecked.png",Texture.class)));
		...
		u.textAreaStyle = new TextFieldStyle();
			...
			//u.textAreaStyle.background=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/TextField.png", Texture.class)));
			//u.textAreaStyle.focusedBackground=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/TextFieldChecked.png", Texture.class)));
		...
		u.slideStyle.down=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/SlideDown.png",Texture.class)));
		u.slideStyle.checked=new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/SlideDown.png",Texture.class)));
