...
public class HomeScreen implements Screen, InputProcessor {
	...
	public void show() {
		...
		u.standardButtonStyle.up = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/Filled.png", Texture.class)));
		u.standardButtonStyle.down = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/FilledChecked.png", Texture.class)));
		u.standardButtonStyle.checked = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/FilledChecked.png", Texture.class)));
		u.standardButtonStyle.font = u.mediumFnt;
		u.standardButtonStyle.fontColor = u.darkL;
		u.redButtonStyle = new TextButtonStyle();
		u.redButtonStyle.up = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/FilledRed.png", Texture.class)));
		u.redButtonStyle.down = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/FilledRedChecked.png", Texture.class)));
		u.redButtonStyle.checked = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/FilledRedChecked.png", Texture.class)));
		u.redButtonStyle.font = u.mediumFnt;
		u.redButtonStyle.fontColor = u.darkL;
		...
		// u.linkButtonStyle.up=new TextureRegionDrawable(new
		...
		// u.sortButtonStyle.up=new TextureRegionDrawable(new
		// TextureRegion(u.assets.get("UI/FilledChecked.png", Texture.class)));
		...
		// u.errorButtonStyle.up=new TextureRegionDrawable(new
		// TextureRegion(u.assets.get("UI/TextField.png", Texture.class)));
		u.plainTextStyle = new TextFieldStyle();
		...
		u.textFieldStyle.background = new TextureRegionDrawable(
		...
		// TextureRegion(u.assets.get("UI/TextFieldChecked.png",
		// Texture.class)));
		u.viewAreaStyle = new TextFieldStyle();
		u.viewAreaStyle.font = u.supersmallFnt;
		u.viewAreaStyle.fontColor = Color.WHITE;
		// u.viewAreaStyle.background=new TextureRegionDrawable(new
		// TextureRegion(u.assets.get("UI/TextField.png", Texture.class)));
		u.checkStyle = new CheckBoxStyle();
		u.checkStyle.checkboxOff = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/CheckBox.png", Texture.class)));
		u.checkStyle.checkboxOn = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/CheckBoxChecked.png", Texture.class)));
		u.checkStyle.checked = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/CheckBoxChecked.png", Texture.class)));
		u.checkStyle.font = u.smallFnt;
		u.slideStyle = new ButtonStyle();
		u.slideStyle.up = new TextureRegionDrawable(new TextureRegion(u.assets.get("UI/SlideUp.png", Texture.class)));
		u.slideStyle.down = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/SlideDown.png", Texture.class)));
		u.slideStyle.checked = new TextureRegionDrawable(
				new TextureRegion(u.assets.get("UI/SlideDown.png", Texture.class)));
	...
	public void render(float delta) {
		...
		if (u.myAcc != null) {
			if (!u.myAcc.confirmed) {
				u.setScreen(new ConfirmationScreen(u));
			} else {
				u.setScreen(new MainScreen(u));
			}
		}
		if (logoMoveAnim < .55f) {
			logoMoveAnim += (.55 - logoMoveAnim) / 2;
		}
		if (logoMoveAnim > .4f && fade < 1 && !fadeOut) {
			fade += (1 - fade) / 2;
		}
